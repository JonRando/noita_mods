...
wand.deck_capacity = {2,2}
wand.actions_per_round = 1
wand.reload_time = {90,100}
wand.shuffle_deck_when_empty = 0
wand.fire_rate_wait = {10,20}
wand.spread_degrees = {0,2}
wand.speed_multiplier = 1
wand.mana_charge_speed = {10,15}
wand.mana_max = {100,120}
wand.actions = { "TENTACLE", "TENTACLE_TIMER" }
...
--AddGunAction( entity_id, "UNSTABLE_GUNPOWDER" )
