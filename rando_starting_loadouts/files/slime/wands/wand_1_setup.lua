...
local wand = { }
wand.name = {"slime_wand"}
wand.deck_capacity = {2,3}
wand.actions_per_round = 1
wand.reload_time = {10,30}
wand.shuffle_deck_when_empty = 0
wand.fire_rate_wait = {5,10}
wand.spread_degrees = {0,5}
wand.speed_multiplier = 1
wand.mana_charge_speed = {20,40}
wand.mana_max = {90,140}
wand.actions = { "LIGHT_BULLET_TIMER", "LIGHT_BULLET_TRIGGER" }
...
AddGunAction( entity_id, "MIST_SLIME" )
