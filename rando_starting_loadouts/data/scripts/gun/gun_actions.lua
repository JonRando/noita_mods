actions =
{
	...
	},
	{
		...
		sprite_unidentified = "data/ui_gfx/gun_actions/sinewave_unidentified.png",
		type 		= ACTION_TYPE_MODIFIER,
		spawn_level                       = "1,3,5", -- SINEWAVE
		spawn_probability                 = "1,1,1", -- SINEWAVE
		price = 30,
		mana = 0,
		--max_uses = 150,
		action 		= function()
			...
			draw_actions( 1, true )
			c.fire_rate_wait    = math.max(0, c.fire_rate_wait - 3)
		end,
	},
	{
		id          = "FLY_UPWARDS",
	...
	},
	{
		...
		action 		= function()
			...
			c.fire_rate_wait    = math.max(0, c.fire_rate_wait - 4)
		end,
	},
	{
		id          = "BOUNCE",
	...
	},
	{
		...
		sprite_unidentified = "data/ui_gfx/gun_actions/explosive_projectile_unidentified.png",
		type 		= ACTION_TYPE_MODIFIER,
		spawn_level                       = "2,3,4,5,6", -- EXPLOSIVE_PROJECTILE
		spawn_probability                 = "1,1,1,1,1", -- EXPLOSIVE_PROJECTILE
		price = 180,
		mana = 80,
		max_uses = 8,
		action 		= function()
	...
	},
	{
		...
		sprite_unidentified = "data/ui_gfx/gun_actions/chaos_polymorph_field_unidentified.png",
		type 		= ACTION_TYPE_STATIC_PROJECTILE,
		spawn_level                       = "2,3,4,5,6", -- CHAOS_POLYMORPH_FIELD
		spawn_probability                 = "1,1,1,1,1", -- CHAOS_POLYMORPH_FIELD
		price = 250,
		mana = 120,
		max_uses = 4,
		action 		= function()
	...
	},
	{
		...
		sprite_unidentified = "data/ui_gfx/gun_actions/chaos_polymorph_field_unidentified.png",
		type 		= ACTION_TYPE_STATIC_PROJECTILE,
		spawn_level                       = "3,4,5,6", -- CHAOS_POLYMORPH_FIELD
		spawn_probability                 = "1,1,1,1", -- CHAOS_POLYMORPH_FIELD
		price = 300,
		mana = 140,
		max_uses = 4,
		action 		= function()
	...
	},
	{
		...
		sprite_unidentified = "data/ui_gfx/gun_actions/chaos_polymorph_field_unidentified.png",
		type 		= ACTION_TYPE_STATIC_PROJECTILE,
		spawn_level                       = "2,5,6", -- CHAOS_POLYMORPH_FIELD
		spawn_probability                 = "1,1,1", -- CHAOS_POLYMORPH_FIELD
		price = 250,
		mana = 120,
		max_uses = 3,
		action 		= function()
	...
	},
	{
		...
		spawn_probability                 = "1,1,1,1,1", -- ACID_TRAIL
		price = 160,
		mana = 15,
		--max_uses = 50,
	...
	},
	{
		...
		sprite_unidentified = "data/ui_gfx/gun_actions/oil_trail_unidentified.png",
		type 		= ACTION_TYPE_MODIFIER,
		spawn_level                       = "1,2,3,4", -- oil_TRAIL
		spawn_probability                 = "1,1,1,1", -- oil_TRAIL
		price = 160,
		mana = 10,
		--max_uses = 50,
	...
	},
	{
		...
		spawn_probability                   = "1,1,1,1", -- LIGHT_BULLET_TRIGGER
		price = 140,
		mana = 10,
		--max_uses = 100,
		action 		= function()
	...
	},
	{
		...
		spawn_probability                   = "1,1,1", -- LIGHT_BULLET_TIMER
		price = 140,
		mana = 10,
		--max_uses = 100,
		action 		= function()
	...
	},
	{
		...
		action 		= function()
			...
			-- damage = 0.1
			c.fire_rate_wait = math.max(c.fire_rate_wait - 2, 0)
	...
	},
	{
		...
		sprite_unidentified = "data/ui_gfx/gun_actions/spitter_unidentified.png",
		type 		= ACTION_TYPE_PROJECTILE,
		spawn_level                       = "2,3,4,5", -- SPITTER
		spawn_probability                 = "1,1,1,1", -- SPITTER
		price = 220,
		mana = 30,
		--max_uses = 120,
		action 		= function()
	...
	},
	{
		...
		action 		= function()
			...
			-- damage = 0.1
			c.fire_rate_wait = math.max(c.fire_rate_wait - 4, 0)
	...
	},
	{
		...
		sprite_unidentified = "data/ui_gfx/gun_actions/rocket_unidentified.png",
		type 		= ACTION_TYPE_PROJECTILE,
		spawn_level                       = "10", -- ROCKET
		spawn_probability                 = "1", -- ROCKET
		price = 420,
		mana = 300,
		max_uses    = 1, 
		action 		= function()
	...
	},
	{
		...
		action 		= function()
			...
			c.fire_rate_wait = c.fire_rate_wait + 200
			current_reload_time = current_reload_time + 600
		end,
	},
}